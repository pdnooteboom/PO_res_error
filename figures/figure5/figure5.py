...
exte4 = [(lon4-55), lon4+20, lat4-15, lat4+25]
...
plt.scatter(hxs3, hys3, c=ch, s=size, label='1', alpha=opac)
plt.scatter(lxs3, lys3, c=cl, s=size, label='4', alpha=opac)
plt.scatter(lxs30, lys30, c=cd, s=size, label='3', alpha=opac)
